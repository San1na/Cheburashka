--[[
    1) Залей main.lua на GitHub
    2) Вставь raw ссылку сюда:
    https://raw.githubusercontent.com/USERNAME/REPOSITORY/BRANCH/main.lua
]]

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/USERNAME/REPOSITORY/BRANCH/main.lua"))()
...
miscMain:AddKeybind({
    ...
    OnChanged = function(newKey)
        ...
        print("Menu key changed:", newKey.Name)
    end,
})
